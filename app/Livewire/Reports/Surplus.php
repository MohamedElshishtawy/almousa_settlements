...
//        }
    ...
    public function save($forMeal = null)
    {
        ...
        return redirect()->route('managers.reports.surplus', [$this->officeMission->id , $this->date, $this->selectedMeal])->with('success', 'تم الحفظ بنجاح;');
    }
    ...
    public function delete()
    {
        if ($this->surplus) {
            $this->surplus->delete();
            return redirect()->route('managers.reports.surplus', [$this->officeMission->id, $this->date, $this->selectedMeal])->with('success', 'تم الحذف بنجاح;');
        }
