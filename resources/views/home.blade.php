                    ...
                    <div class="card-body">
                        ...
                        @else
                            ...
                            <article class="mt-3">
                                ...
                                <ul class="mt-2">
                                    <li>أولا <span class="text-success">  صل على الحبيب وإستعن بالله</span> فالأمر بسيط
                                        إن شاء الله
                                    </li>
                                    ...
                                    <li>ستظهر كل المحاضر المتاحة <span class="text-danger">مع بداية اول يوم</span> للعمل
                                        فى المقر إن شاء الله وستخنفى المحاضر بعد إنتهاء الفترة
                                    </li>
                                    <li>سوف يتمكن الأدمن الخاص بالموقع الإطلاع على التعديدلات والمدخلات التى قد
                                        أدخلتها
                                    </li>
                                </ul>
                            </article>
