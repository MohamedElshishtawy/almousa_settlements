        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('admin.users.create') }}" class="btn btn-success btn-sm"><i class="fa-solid fa-plus"></i> إضافة موظف</a>
                </div>
                    ...
                    <table class="table">
                        ...
                        @php($n = 0)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.users.edit', $employee->id) }}" class="btn btn-primary btn-sm"><i class="fa-solid fa-edit"></i> تعديل</a>
                                </td>
                                <td>
                                    <form action="{{ route('admin.users.delete', $employee->id) }}" method="post">
                                        @csrf
                                        @method('DELETE')
