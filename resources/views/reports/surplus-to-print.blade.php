    ...
    @foreach($staticProducts as $staticProduct)
        <tr>
            ...
            @if ($staticProduct['surplusData']['amountForMeal'])
                <td>{{ \Alkoumi\LaravelArabicNumbers\Numbers::ShowInArabicDigits(round($staticProduct['surplusData']['amountForMeal'], 5)) }}</td>
                <td>{{ \Alkoumi\LaravelArabicNumbers\Numbers::ShowInArabicDigits(round($staticProduct['surplusData']['totalAmountForMeal'], 5)) }}</td>
                <td>{{ \Alkoumi\LaravelArabicNumbers\Numbers::ShowInArabicDigits(round($staticProduct['surplusData']['surplusBenefitFromTypes'], 5)) }}</td>
                <td>{{ \Alkoumi\LaravelArabicNumbers\Numbers::ShowInArabicDigits(round($staticProduct['surplusData']['totalSurplus'], 5)) }}</td>
                <td>{{ \Alkoumi\LaravelArabicNumbers\Numbers::ShowInArabicDigits(round($staticProduct['surplusData']['total'], 5)) }}</td>
            @else
                <td>-</td>
                <td>-</td>
                <td>-</td>
