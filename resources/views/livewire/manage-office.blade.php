    ...
    <form wire:submit.prevent="save">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <select id="living_id" class="form-select @error('living_id') is-invalid @enderror"
                        wire:model="living_id">
            ...
            <div class="col-md-6">
                ...
                <select id="mission_id" class="form-select @error('mission_id') is-invalid @enderror"
                        wire:model="mission_id">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="date" id="getting_ready_start_date"
                       class="form-control @error('getting_ready_start_date') is-invalid @enderror"
                       wire:model="getting_ready_start_date" placeholder="أكتب هنا">
            ...
            <div class="col-md-6">
                ...
                <input type="date" id="getting_ready_end_date"
                       class="form-control @error('getting_ready_end_date') is-invalid @enderror"
                       wire:model.defer="getting_ready_end_date" placeholder="أكتب هنا">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="date" id="start_date" class="form-control @error('start_date') is-invalid @enderror"
                       wire:model.defer="start_date" placeholder="أكتب هنا">
            ...
            <div class="col-md-6">
                ...
                <input type="date" id="end_date" class="form-control @error('end_date') is-invalid @enderror"
                       wire:model.defer="end_date" placeholder="أكتب هنا">
