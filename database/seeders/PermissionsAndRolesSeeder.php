...
class PermissionsAndRolesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permissions = [
            ...
            'import_create', 'import_edit', 'import_delete', 'import_show_price',
            'import_model2_create', 'import_model2_create_price',
            // surplus
            'surplus_create', 'surplus_edit', 'surplus_delete', 'surplus_show_price',
            'surplus_model2_create', 'surplus_model2_price',
            // employment
            'employment_create', 'employment_edit', 'employment_delete',
            // dry food
            'dry_food_create', 'dry_food_edit', 'dry_food_delete', 'dry_food_print',
            // tasks
